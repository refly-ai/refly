...
- summary: Brief summary of the result (~100 tokens from the end)
...
**Important - Don't miss text-only results:**
- Empty outputFiles does NOT mean the result is unimportant
- Results with high contentTokens (>500) often contain valuable analysis, reasoning, or text content
- Always check both summary AND contentTokens to decide if you need full content
- If the task relates to a previous result's topic, read it even without outputFiles

**Best Practice:**
- Read the summary first to determine if you need the full content
- For results with contentTokens > 500 and relevant summary, prefer reading the full content
