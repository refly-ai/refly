...
import type { ModelParameterRule } from "@/components/header/account-setting/model-provider-page/declarations"
...
export const fetchModelParams = (providerName: string, modelId: string) => {
  return get(
    `workspaces/current/model-providers/${providerName}/models/parameter-rules`,
    {
      params: {
        model: modelId,
      },
