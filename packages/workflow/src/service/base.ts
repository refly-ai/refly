...
import type {
  ...
  MessageReplace,
  ThoughtItem,
} from "@/components/base/chat/chat/type"
...
import { removeAccessToken } from "@/components/share/utils"
...
export type IOnIterationNexted = (
  workflowStarted: IterationNextedResponse,
) => void
