...
export const syncWorkflowDraft = ({
  ...
  url: string
  params: Pick<FetchWorkflowDraftResponse, "graph" | "features">
}) => {
...
export const fetchNodesDefaultConfigs: Fetcher<
  NodesDefaultConfigsResponse,
  string
> = url => {
...
export const fetchWorkflowRunHistory: Fetcher<
  WorkflowRunHistoryResponse,
  string
> = url => {
...
export const fetcChatRunHistory: Fetcher<
  ChatRunHistoryResponse,
  string
> = url => {
...
export const fetchPublishedWorkflow: Fetcher<
  FetchWorkflowDraftResponse,
  string
> = url => {
...
export const fetchNodeDefault = (
  appId: string,
  blockType: BlockEnum,
  query = {},
) => {
  return get(
    `apps/${appId}/workflows/default-workflow-block-configs/${blockType}`,
    {
...
export const updateWorkflowDraftFromDSL = (appId: string, data: string) => {
  return post<FetchWorkflowDraftResponse>(
    `apps/${appId}/workflows/draft/import`,
    { body: { data } },
  )
}
