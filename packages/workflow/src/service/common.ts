...
export const setup: Fetcher<CommonResponse, { body: Record<string, any> }> = ({
  body,
}) => {
  return post<CommonResponse>("/setup", { body })
}

export const initValidate: Fetcher<
  CommonResponse,
...
> = ({ url, params }) => {
  return get<UserProfileOriginResponse>(url, params, {
    needAllResponseContent: true,
  })
}

export const updateUserProfile: Fetcher<
  CommonResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const fetchLanggeniusVersion: Fetcher<
  LangGeniusVersionResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const oneMoreStep: Fetcher<
  CommonResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const fetchMembers: Fetcher<
...
export const fetchProviders: Fetcher<
  Provider[] | null,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const validateProviderKey: Fetcher<
  ValidateOpenAIKeyResponse,
  { url: string; body: { token: string } }
> = ({ url, body }) => {
  return post<ValidateOpenAIKeyResponse>(url, { body })
}
export const updateProviderAIKey: Fetcher<
  UpdateOpenAIKeyResponse,
  {
    url: string
    body: { token: string | ProviderAzureToken | ProviderAnthropicToken }
  }
> = ({ url, body }) => {
  return post<UpdateOpenAIKeyResponse>(url, { body })
}

export const fetchAccountIntegrates: Fetcher<
...
export const inviteMember: Fetcher<
  InvitationResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const updateMemberRole: Fetcher<
  CommonResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const deleteMemberOrCancelInvitation: Fetcher<
  CommonResponse,
  { url: string }
> = ({ url }) => {
...
export const fetchFilePreview: Fetcher<
  { content: string },
  { fileID: string }
> = ({ fileID }) => {
...
export const fetchCurrentWorkspace: Fetcher<
  ICurrentWorkspace,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const updateCurrentWorkspace: Fetcher<
  ICurrentWorkspace,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const switchWorkspace: Fetcher<
  CommonResponse & { new_tenant: IWorkspace },
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
  return post<CommonResponse & { new_tenant: IWorkspace }>(url, { body })
}

export const fetchDataSource: Fetcher<
...
export const syncDataSourceNotion: Fetcher<CommonResponse, { url: string }> = ({
  url,
}) => {
  return get<CommonResponse>(url)
}

export const updateDataSourceNotionAction: Fetcher<
  CommonResponse,
  { url: string }
> = ({ url }) => {
...
export const fetchPluginProviders: Fetcher<
  PluginProvider[] | null,
  string
> = url => {
...
export const validatePluginProviderKey: Fetcher<
  ValidateOpenAIKeyResponse,
  { url: string; body: { credentials: any } }
> = ({ url, body }) => {
  return post<ValidateOpenAIKeyResponse>(url, { body })
}
export const updatePluginProviderAIKey: Fetcher<
  UpdateOpenAIKeyResponse,
  { url: string; body: { credentials: any } }
> = ({ url, body }) => {
  return post<UpdateOpenAIKeyResponse>(url, { body })
...
export const invitationCheck: Fetcher<
  CommonResponse & { is_valid: boolean; workspace_name: string },
  {
    url: string
    params: { workspace_id: string; email: string; token: string }
  }
> = ({ url, params }) => {
  return get<CommonResponse & { is_valid: boolean; workspace_name: string }>(
    url,
    { params },
  )
}

export const activateMember: Fetcher<
  CommonResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const fetchModelProviders: Fetcher<
  { data: ModelProvider[] },
  string
> = url => {
...
export const fetchModelProviderCredentials: Fetcher<
...
export const fetchModelProviderModelList: Fetcher<
  { data: ModelItem[] },
  string
> = url => {
...
export const validateModelProvider: Fetcher<
  ValidateOpenAIKeyResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<ValidateOpenAIKeyResponse>(url, { body })
...
export const validateModelLoadBalancingCredentials: Fetcher<
  ValidateOpenAIKeyResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<ValidateOpenAIKeyResponse>(url, { body })
...
export const setModelProvider: Fetcher<
  CommonResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const deleteModelProvider: Fetcher<
  CommonResponse,
  { url: string; body?: any }
> = ({ url, body }) => {
...
export const changeModelProviderPriority: Fetcher<
  CommonResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const setModelProviderModel: Fetcher<
  CommonResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const deleteModelProviderModel: Fetcher<
  CommonResponse,
  { url: string }
> = ({ url }) => {
  return del<CommonResponse>(url)
...
export const fetchDefaultModal: Fetcher<
...
export const updateDefaultModel: Fetcher<
  CommonResponse,
  { url: string; body: any }
> = ({ url, body }) => {
  return post<CommonResponse>(url, { body })
...
export const fetchModelParameterRules: Fetcher<
...
export const fetchFileUploadConfig: Fetcher<
  FileUploadConfigResponse,
  { url: string }
> = ({ url }) => {
...
export const fetchFreeQuotaVerify: Fetcher<
  { result: string; flag: boolean; reason: string },
  string
> = url => {
...
export const fetchApiBasedExtensionList: Fetcher<
  ApiBasedExtension[],
  string
> = url => {
...
export const fetchApiBasedExtensionDetail: Fetcher<
  ApiBasedExtension,
  string
> = url => {
  return get(url) as Promise<ApiBasedExtension>
...
export const addApiBasedExtension: Fetcher<
  ApiBasedExtension,
  { url: string; body: ApiBasedExtension }
> = ({ url, body }) => {
  return post(url, { body }) as Promise<ApiBasedExtension>
}

export const updateApiBasedExtension: Fetcher<
  ApiBasedExtension,
  { url: string; body: ApiBasedExtension }
> = ({ url, body }) => {
  return post(url, { body }) as Promise<ApiBasedExtension>
...
export const deleteApiBasedExtension: Fetcher<
  { result: string },
  string
> = url => {
...
export const fetchCodeBasedExtensionList: Fetcher<
  CodeBasedExtension,
  string
> = url => {
...
export const fetchSupportRetrievalMethods: Fetcher<
  RetrievalMethodsRes,
  string
> = url => {
