...
if (
  import.meta.env.NEXT_PUBLIC_API_PREFIX &&
  import.meta.env.NEXT_PUBLIC_PUBLIC_API_PREFIX
) {
  apiPrefix = import.meta.env.NEXT_PUBLIC_API_PREFIX
  publicApiPrefix = import.meta.env.NEXT_PUBLIC_PUBLIC_API_PREFIX
} else if (
  globalThis.document?.body?.getAttribute("data-api-prefix") &&
  globalThis.document?.body?.getAttribute("data-pubic-api-prefix")
) {
  // Not build can not get env from import.meta.env.NEXT_PUBLIC_ in browser https://nextjs.org/docs/basic-features/environment-variables#exposing-environment-variables-to-the-browser
