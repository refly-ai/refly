    ...
    <div className="flex w-full items-center justify-between">
      ...
      <div className="flex items-center space-x-2">
        ...
        {showFeedback && feedback.rating && feedback.rating === "like" && (
          <Tooltip selector="undo-feedback-like" content="Undo Great Rating">
            <div
              onClick={() => {
                onFeedback({
                  rating: null,
        ...
        {showFeedback && !feedback.rating && (
          <div className="flex space-x-1 rounded-lg border border-gray-200 p-[1px]">
            <Tooltip selector="feedback-like" content="Great Rating">
              <div
                onClick={() => {
                  onFeedback({
                    rating: "like",
            ...
            <Tooltip selector="feedback-dislike" content="Undesirable Response">
              <div
                onClick={() => {
                  onFeedback({
                    rating: "dislike",
