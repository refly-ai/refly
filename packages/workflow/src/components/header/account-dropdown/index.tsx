...
import { LogOut01 } from "@/components/base/icons/src/vender/line/general"
      ...
      <Menu as="div" className="relative inline-block text-left">
        {({ open }) => (
          <>
            <div>
              <Menu.Button
                className={`mobile:px-1 inline-flex items-center rounded-[20px] py-1 pl-1 pr-2.5 text-sm text-gray-700 hover:bg-gray-200 ${open && "bg-gray-200"} `}>
                <Avatar
            ...
            <Transition
              ...
              <Menu.Items className="max-w-80 absolute right-0 mt-1.5 w-60 origin-top-right divide-y divide-gray-100 rounded-lg bg-white shadow-lg">
                <Menu.Item>
                  <div className="flex flex-nowrap items-center px-4 py-[13px]">
                    ...
                    />
                    <div className="grow">
                      <div className="break-all text-[14px] font-normal leading-5 text-gray-800">
                        {userProfile.name}
                      </div>
                      <div className="break-all text-xs font-normal leading-[18px] text-gray-500">
                        {userProfile.email}
                      </div>
                    </div>
                  </div>
                ...
                <div className="px-1 py-1">
                  ...
                  <Menu.Item>
                    <Link
                      ...
                      <ArrowUpRight className="hidden h-[14px] w-[14px] text-gray-500 group-hover:flex" />
                    </Link>
                  </Menu.Item>
                  <Menu.Item>
                    <Link
                  ...
                  {document?.body?.getAttribute("data-public-site-about") !==
                    ...
                    <Menu.Item>
                      <div
                        className={classNames(itemClassName, "justify-between")}
                ...
                <Menu.Item>
                  <div className="p-1" onClick={() => handleLogout()}>
                    <div className="group flex h-9 cursor-pointer items-center justify-between rounded-lg px-3 hover:bg-gray-50">
                      <div className="text-[14px] font-normal text-gray-700">
                        {t("common.userProfile.logout")}
                      </div>
                      <LogOut01 className="hidden h-[14px] w-[14px] text-gray-500 group-hover:flex" />
                    </div>
                  </div>
                </Menu.Item>
              </Menu.Items>
