    ...
    <Modal
      ...
      <div className="py-2">
        ...
        <input
          ...
          placeholder={
            t("common.apiBasedExtension.modal.name.placeholder") || ""
          }
        />
      </div>
      <div className="py-2">
        ...
        <input
          ...
          className="block h-9 w-full appearance-none rounded-lg bg-gray-100 px-3 text-sm text-gray-900 outline-none"
          placeholder={
            t("common.apiBasedExtension.modal.apiEndpoint.placeholder") || ""
          }
        />
      </div>
      <div className="py-2">
        ...
        <div className="flex items-center">
          <input
            ...
            placeholder={
              t("common.apiBasedExtension.modal.apiKey.placeholder") || ""
            }
          />
        </div>
      </div>
