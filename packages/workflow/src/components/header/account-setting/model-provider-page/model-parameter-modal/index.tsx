...
const ModelParameterModal: FC<ModelParameterModalProps> = ({
  ...
  const handleChangeModel = ({ provider, model }: DefaultModel) => {
    ...
    const targetModelItem = targetProvider?.models.find(
      modelItem => modelItem.model === model,
    )
    setModel({
      modelId: model,
      provider,
  ...
  return (
    <PortalToFollowElem
      ...
      <div className="relative">
        ...
        <PortalToFollowElemContent
          className={cn(portalToFollowElemContentClassName, "z-[60]")}>
          <div
            className={cn(
              popupClassName,
            ...
            {!hideDebugWithMultipleModel && (
              <div
                className="text-primary-600 flex h-[50px] cursor-pointer items-center justify-between rounded-b-xl border-t border-t-gray-100 bg-gray-50 px-6 text-xs font-medium"
