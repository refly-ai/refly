            ...
            <div
              className={classNames(
                ...
                draftConfig.enabled
                  ...
                  : "border-primary-400 cursor-default",
              )}
              onClick={
                draftConfig.enabled
                  ? () => toggleModalBalancing(false)
                  : undefined
              }>
              <div className="flex select-none items-center gap-2 px-[15px] py-3">
                <div className="flex h-8 w-8 shrink-0 grow-0 items-center justify-center rounded-lg border bg-white">
                  {Boolean(model) && (
                    <ModelIcon
                      className="shrink-0"
                      provider={provider}
