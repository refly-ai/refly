...
import { Beaker02 } from "@/components/base/icons/src/vender/solid/education"
import { TerminalSquare } from "@/components/base/icons/src/vender/solid/development"
...
const EnvNav = () => {
  ...
  return (
    <div
      className={`mr-4 flex h-[22px] items-center rounded-md border px-2 text-xs font-medium ${headerEnvClassName[langeniusVersionInfo.current_env]} `}>
      {langeniusVersionInfo.current_env === "TESTING" && (
        <>
