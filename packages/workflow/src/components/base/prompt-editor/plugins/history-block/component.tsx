...
const HistoryBlockComponent: FC<HistoryBlockComponentProps> = ({
  ...
  return (
    <div
      className={`group inline-flex h-6 items-center rounded-[5px] border border-transparent pl-1 pr-0.5 text-[#DD2590] hover:bg-[#FCE7F6] ${open ? "bg-[#FCE7F6]" : "bg-[#FDF2FA]"} ${isSelected && "!border-[#F670C7]"} `}
      ref={ref}>
      ...
      <PortalToFollowElem
        ...
        <PortalToFollowElemTrigger ref={triggerRef}>
          <div
            className={`flex h-[18px] w-[18px] cursor-pointer items-center justify-center rounded ${open ? "bg-[#DD2590] text-white" : "group-hover:shadow-xs bg-white/50 group-hover:bg-white"} `}>
          ...
          <div className="w-[360px] rounded-xl bg-white shadow-lg">
            <div className="p-4">
              ...
              <div className="flex items-center text-sm text-gray-700">
                <div className="mr-1 w-20 text-xs font-semibold">
                  {localRoleName?.user}
                </div>
