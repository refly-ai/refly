...
export const DELETE_WORKFLOW_VARIABLE_BLOCK_COMMAND = createCommand(
  "DELETE_WORKFLOW_VARIABLE_BLOCK_COMMAND",
)
export const CLEAR_HIDE_MENU_TIMEOUT = createCommand("CLEAR_HIDE_MENU_TIMEOUT")
export const UPDATE_WORKFLOW_NODES_MAP = createCommand(
...
const WorkflowVariableBlock = memo(
  ({ workflowNodesMap, onInsert, onDelete }: WorkflowVariableBlockType) => {
