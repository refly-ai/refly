...
import { MessageHeartCircle } from "@/components/base/icons/src/vender/solid/communication"
...
const FeatureModal: FC<FeatureModalProps> = ({ onChange }) => {
    ...
    <Modal
      ...
      <div className="pb-10 pt-5">
        ...
        <FeatureGroup
          ...
          <>
            <FeatureItem
              icon={<MessageHeartCircle className="h-4 w-4 text-[#DD2590]" />}
