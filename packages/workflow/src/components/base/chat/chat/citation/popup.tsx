  ...
  return (
    <PortalToFollowElem
      ...
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)}>
        <div className="flex h-7 max-w-[240px] items-center rounded-lg bg-white px-2">
      ...
      <PortalToFollowElemContent style={{ zIndex: 1000 }}>
        <div className="w-[360px] rounded-xl bg-gray-50 shadow-lg">
          ...
          <div className="max-h-[450px] overflow-auto rounded-lg bg-white px-4 py-0.5">
                  ...
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    {showHitInfo && (
                      <Link
                        ...
                        className="text-primary-600 hidden h-[18px] items-center text-xs group-hover:flex">
