    ...
    <div className="flex max-h-[80%] w-full max-w-[720px] flex-col">
      <div
        className={cn(
          ...
          showConfigPanelBeforeChat &&
            "border-[0.5px] border-gray-100 shadow-lg",
        ...
        <div
          style={CssTransform(
            themeBuilder.theme?.roundedBackgroundColorStyle ?? "",
          )}
          ...
          {!showConfigPanelBeforeChat && collapsed && (
            <>
              ...
              <Button
                styleCss={CssTransform(
                  themeBuilder.theme?.backgroundButtonDefaultColorStyle ?? "",
                )}
      ...
      {showConfigPanelBeforeChat && (site || customConfig) && (
        <div className="mt-4 flex flex-wrap items-center justify-between py-2 text-xs text-gray-400">
          {site?.privacy_policy ? (
            <div className={cn(isMobile && "mb-2 w-full text-center")}>
