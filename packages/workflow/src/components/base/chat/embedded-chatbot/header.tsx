  ...
  return (
    <div
      ...
      <Tooltip
        ...
        position="top">
        <div
          className="flex h-8 w-8 cursor-pointer items-center justify-center hover:rounded-lg hover:bg-black/5"
          onClick={() => {
            onCreateNewChat?.()
          }}>
          <RiRefreshLine
            className="h-4 w-4 text-sm font-bold text-white"
            color={theme?.colorPathOnHeader}
          />
        </div>
      </Tooltip>
    </div>
