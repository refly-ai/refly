...
import { FlipBackward } from "@/components/base/icons/src/vender/line/arrows"
import { LanguagesSupported } from "@/i18n/language"
type Props = {
  onReturnToSimpleMode: () => void
}

const AdvancedModeWarning: FC<Props> = ({ onReturnToSimpleMode }) => {
  ...
  return (
    <div className="mb-3 rounded-xl border border-[#FEF0C7] bg-[#FFFAEB] px-4 py-3">
      <div className="mb-2 text-xs font-bold leading-[18px] text-[#DC6803]">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1">
          <div
            ...
            <FlipBackward className="h-3 w-3 text-white" />
