  ...
  const handleSave = () => {
    if (!localeData.type) {
      notify({
        ...
        message: t("appDebug.errorMessage.valueOfVarRequired", {
          key: t("appDebug.feature.tools.modal.toolType.title"),
        }),
      })
      return
    }
    ...
    if (!localeData.label) {
      notify({
        type: "error",
        message: t("appDebug.errorMessage.valueOfVarRequired", {
          key: t("appDebug.feature.tools.modal.name.title"),
        }),
      })
      return
    }
    ...
    if (!localeData.variable) {
      notify({
        type: "error",
        message: t("appDebug.errorMessage.valueOfVarRequired", {
          key: t("appDebug.feature.tools.modal.variableName.title"),
        }),
      })
      return
    }
    ...
    if (
      localeData.variable &&
      !/[a-zA-Z_][a-zA-Z0-9_]{0,29}/g.test(localeData.variable)
    ) {
      notify({
        type: "error",
        message: t("appDebug.varKeyError.notValid", {
          key: t("appDebug.feature.tools.modal.variableName.title"),
        }),
      })
      return
    ...
    if (onValidateBeforeSave && !onValidateBeforeSave(formatedData)) return
    ...
    <Modal
      ...
      <div className="py-2">
        ...
        <div className="flex items-center">
          <input
            ...
            placeholder={
              t("appDebug.feature.tools.modal.name.placeholder") || ""
            }
          />
          <AppIcon
            size="large"
      ...
      <div className="py-2">
        ...
        <input
          ...
          placeholder={
            t("appDebug.feature.tools.modal.variableName.placeholder") || ""
          }
        />
      </div>
      {localeData.type === "api" && (
        <div className="py-2">
          <div className="flex h-9 items-center justify-between text-sm font-medium text-gray-900">
            ...
            <a
              ...
              className="hover:text-primary-600 group flex items-center text-xs font-normal text-gray-500">
