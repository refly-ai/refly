...
import {
  MessageCheckRemove,
  MessageFastPlus,
} from "@/components/base/icons/src/vender/line/communication"
...
import RemoveAnnotationConfirmModal from "@/components/annotation/remove-annotation-confirm-modal"
          ...
          <div>
            <div
              ...
              className={cn(
                ...
                "flex items-center space-x-1 rounded-md p-1 text-xs font-medium leading-4",
              )}
