        ...
        <div className="min-w-[192px] rounded-lg border border-gray-200 bg-white shadow-lg">
          <div className="p-1">
            <SelectItem
              ...
              value="string"
              text={t("appDebug.variableConig.string")}
              onClick={handleChange}></SelectItem>
            <SelectItem
              type={InputVarType.paragraph}
              value="paragraph"
              text={t("appDebug.variableConig.paragraph")}
              onClick={handleChange}></SelectItem>
            <SelectItem
              type={InputVarType.select}
              value="select"
              text={t("appDebug.variableConig.select")}
              onClick={handleChange}></SelectItem>
            <SelectItem
              type={InputVarType.number}
              value="number"
              text={t("appDebug.variableConig.number")}
              onClick={handleChange}></SelectItem>
          </div>
          ...
          <div className="p-1">
            <SelectItem
              Icon={ApiConnection}
              value="api"
              text={t("appDebug.variableConig.apiBasedVar")}
              onClick={handleChange}></SelectItem>
          </div>
        </div>
      </PortalToFollowElemContent>
