...
import { useChat } from "@/components/base/chat/chat/hooks"
import { useDebugConfigurationContext } from "@/context/debug-configuration"
import type { OnSend } from "@/components/base/chat/types"
...
const ChatItem: FC<ChatItemProps> = ({ modelAndParameter }) => {
  ...
  const { modelConfig, appId, inputs, visionConfig, collectionList } =
