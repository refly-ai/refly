...
import type { Item } from "@/components/base/dropdown"
import { useProviderContext } from "@/context/provider-context"
import { ModelStatusEnum } from "@/components/header/account-setting/model-provider-page/declarations"
...
const DebugItem: FC<DebugItemProps> = ({
  ...
  return (
    <div
      className={`flex min-w-[320px] flex-col rounded-xl border-[0.5px] border-black/5 bg-white ${className}`}
      style={style}>
      <div className="flex h-10 shrink-0 items-center justify-between border-b-[0.5px] border-b-black/5 px-3">
        <div className="flex h-5 w-6 items-center justify-center font-medium italic text-gray-500">
          #{index + 1}
        </div>
