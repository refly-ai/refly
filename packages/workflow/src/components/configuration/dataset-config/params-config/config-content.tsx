...
import TopKItem from "@/components/base/param-item/top-k-item"
import ScoreThresholdItem from "@/components/base/param-item/score-threshold-item"
import RadioCard from "@/components/base/radio-card/simple"
import { RETRIEVE_TYPE } from "@/types/app"
import {
  MultiPathRetrieval,
  NTo1Retrieval,
} from "@/components/base/icons/src/public/common"
...
import type { ModelConfig } from "@/components/workflow/types"
  ...
  return (
    <div>
      <div className="mt-2 space-y-3">
        <RadioCard
          icon={<NTo1Retrieval className="mr-3 h-9 w-9 shrink-0 rounded-lg" />}
          ...
          onChosen={() => {
            setType(RETRIEVE_TYPE.oneWay)
          }}
        />
        <RadioCard
          icon={
            <MultiPathRetrieval className="mr-3 h-9 w-9 shrink-0 rounded-lg" />
          }
      ...
      {type === RETRIEVE_TYPE.multiWay && (
        <>
          <div className="mt-6">
            <div className="text-[13px] font-medium leading-[32px] text-gray-900">
        ...
        <div className="mt-6">
          <div className="flex items-center space-x-0.5">
            ...
            <TooltipPlus
              ...
              <RiQuestionLine className="h-4.5 w-3.5 text-gray-400" />
            </TooltipPlus>
          </div>
          <ModelParameterModal
