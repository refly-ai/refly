...
import ConfigPrompt from "@/components/configuration/config-prompt"
import { AppType } from "@/types/app"
import ConfigVar from "@/components/configuration/config-var"
import OpeningStatement from "@/components/configuration/features/chat-group/opening-statement"
import GroupName from "@/components/configuration/base/group-name"
...
const GetAutomaticRes: FC<IGetAutomaticResProps> = ({
  ...
  const [isLoading, { setTrue: setLoadingTrue, setFalse: setLoadingFalse }] =
    useBoolean(false)
    ...
    <Modal
      ...
      <div className="flex h-[680px] flex-wrap gap-y-4 overflow-y-auto">
        {isShowAutoPromptInput() && (
          <div className="h-full w-full shrink-0 overflow-y-auto border-r border-gray-100 px-8 py-6 sm:w-[360px] xl:w-[480px]">
            <div>
              <div className="text-primary-600 mb-1 text-xl font-semibold">
            ...
            <div className="mt-2 space-y-5">
              <div className="space-y-2">
                ...
                <input
                  className="h-8 w-full rounded-lg bg-gray-50 px-3 text-[13px] font-normal"
                  placeholder={
                    t(
                      "appDebug.automatic.intendedAudiencePlaceHolder",
                    ) as string
                  }
                  value={audiences}
              ...
              <div className="space-y-2">
                ...
                <textarea
                  className="h-[200px] w-full overflow-y-auto rounded-lg bg-gray-50 p-3 text-[13px] font-normal"
                  placeholder={
                    t("appDebug.automatic.solveProblemPlaceHolder") as string
                  }
                  value={hopingToSolve}
                  onChange={e => setHopingToSolve(e.target.value)}
                />
              </div>
        ...
        {!isLoading && res && (
          <div className="h-full w-0 grow overflow-y-auto px-8 pt-6">
            ...
            <div className="sticky bottom-0 right-0 flex justify-end bg-white py-4">
