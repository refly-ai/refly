    ...
    <Modal
      ...
      <div className="pb-10 pt-5">
          ...
          <FeatureGroup
            ...
            <>
              ...
              <FeatureItem
                ...
                onChange={value =>
                  onChange("suggestedQuestionsAfterAnswer", value)
                }
              />
              {showTextToSpeechItem && (
                <FeatureItem
                  icon={<Speaker className="h-4 w-4 text-[#7839EE]" />}
              ...
              {showSpeechToTextItem && (
                <FeatureItem
                  icon={<Microphone01 className="h-4 w-4 text-[#7839EE]" />}
              ...
              <FeatureItem
                icon={<Citations className="h-4 w-4 text-[#FD853A]" />}
        ...
        <FeatureGroup title={t("appDebug.feature.toolbox.title")}>
          <>
            <FeatureItem
              icon={<FileSearch02 className="h-4 w-4 text-[#039855]" />}
              previewImgClassName=""
            ...
            {isChatApp && (
              <FeatureItem
                icon={<MessageFast className="h-4 w-4 text-[#444CE7]" />}
