...
const AdvancedPromptInput: FC<Props> = ({
  ...
  const contextMissing = (
    <div
      ...
      <div className="flex items-center pr-2">
        ...
        <div className="text-[13px] font-medium leading-[18px] text-[#DC6803]">
  ...
  return (
    <div
      className={`relative ${!isContextMissing ? s.gradientBorder : s.warningBorder}`}>
      <div className="rounded-xl bg-white">
        {isContextMissing ? (
          ...
          <div
            className={cn(
              s.boxHeader,
              "hover:shadow-xs flex h-11 items-center justify-between rounded-tl-xl rounded-tr-xl bg-white pb-1 pl-4 pr-3 pt-2",
            )}>
            {isChatMode ? (
