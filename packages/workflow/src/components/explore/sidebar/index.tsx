...
import {
  fetchInstalledAppList as doFetchInstalledAppList,
  uninstallApp,
  updatePinStatus,
...
const SideBar: FC<IExploreSideBarProps> = ({ controlUpdateInstalledApps }) => {
  ...
  return (
    <div className="w-fit shrink-0 cursor-pointer border-gray-200 px-4 pt-6 sm:w-[216px]">
      <div>
        <Link
          href="/explore/apps"
          className={cn(
            ...
            "pc:justify-start pc:w-full mobile:justify-center mobile:w-fit mobile:px-2 flex h-9 items-center gap-2 rounded-lg px-3",
          )}
          style={
            isDiscoverySelected
