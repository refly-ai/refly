...
import StopEmbeddingModal from "@/components/datasets/create/stop-embedding-modal"
...
const ResumeIcon = ({ className }: SVGProps<SVGElement>) => {
  return (
    <svg
      ...
      className={className ?? ""}>
      <path
        d="M10 3.5H5C3.34315 3.5 2 4.84315 2 6.5C2 8.15685 3.34315 9.5 5 9.5H10M10 3.5L8 1.5M10 3.5L8 5.5"
        stroke="#344054"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <div className={s.progressContainer}>
        {new Array(10).fill("").map((_, idx) => (
          <div
            ...
            className={cn(
              s.progressBgItem,
              isEmbedding ? "bg-primary-50" : "bg-gray-100",
            )}
          />
        ))}
        <div
