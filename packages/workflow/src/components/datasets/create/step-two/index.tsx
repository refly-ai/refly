...
import { MessageChatSquare } from "@/components/base/icons/src/public/common"
...
import { Globe01 } from "@/components/base/icons/src/vender/line/mapsAndTravel"
...
const StepTwo = ({
  ...
  const [docLanguage, setDocLanguage] = useState<string>(
    locale !== LanguagesSupported[1] ? "English" : "Chinese",
  )
    ...
    <div className="flex h-full w-full">
      <div ref={scrollRef} className="relative h-full w-full overflow-y-scroll">
        <div
          ...
          {isMobile && (
            <Button
              className="!h-8 border-[0.5px] bg-white font-medium text-gray-700 shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] hover:outline hover:outline-[0.5px] hover:outline-gray-300"
                    ...
                    <div className="w-full">
                      <div className={s.label}>
                        ...
                        <TooltipPlus
                          ...
                          <RiQuestionLine className="ml-1 h-3.5 w-3.5 text-gray-400" />
                        </TooltipPlus>
                      </div>
                      <input
                        type="number"
                    ...
                    <div className="flex w-full flex-col gap-1">
                      ...
                      {rules.map(rule => (
                        <div key={rule.id} className={s.ruleItem}>
                          ...
                          <label
                            htmlFor={rule.id}
                            className="ml-2 cursor-pointer text-sm font-normal text-gray-800">
                            {getRuleName(rule.id)}
                          </label>
                        </div>
                      ))}
          ...
          <div className="max-w-[640px]">
              ...
              {(!hasSetIndexType ||
                ...
                <div
                  ...
                  <div className={s.typeHeader}>
                    ...
                    <div className="pb-0.5 text-xs font-medium text-gray-500">
                      {t("datasetCreation.stepTwo.emstimateCost")}
                    </div>
                    {estimateTokes ? (
                      <div className="text-xs font-medium text-gray-800">
                        {formatNumber(estimateTokes.tokens)} tokens(
                        <span className="text-yellow-500">
                          ${formatNumber(estimateTokes.total_price)}
                        </span>
                        )
                      </div>
                    ) : (
              ...
              <div className="mt-3 rounded-xl border border-gray-100 bg-gray-50">
                <div className="flex items-center justify-between px-5 py-4">
                  ...
                  <div className="mx-3 grow">
                    <div className="text-md mb-[2px] font-medium text-gray-900">
                ...
                {docForm === DocForm.QA && !QATipHide && (
                  <div className="text-medium flex items-center justify-between rounded-b-xl border-t border-amber-100 bg-orange-50 px-5 py-2 text-[13px] leading-[18px] text-amber-500">
            ...
            <div>
              {!datasetId ? (
                ...
                <div
                  className={cn(s.label, "flex items-center justify-between")}>
              ...
              <div className="max-w-[640px]">
                {!datasetId ? (
                  ...
                  <div>
                    <RetrievalMethodInfo value={retrievalConfig} />
                    <div className="mt-2 text-xs font-medium text-gray-500">
              ...
              <div className={s.sourceContent}>
                {dataSourceType === DataSourceType.FILE && (
                  <>
                    ...
                    <div className="flex items-center text-sm font-medium leading-6 text-gray-800">
                      <span
                        className={cn(
                          s.fileIcon,
                ...
                {dataSourceType === DataSourceType.WEB && (
                  <>
                    ...
                    <div className="flex items-center text-sm font-medium leading-6 text-gray-800">
                      <Globe01 className="mr-1 shrink-0" />
      ...
      <FloatRightContainer
        ...
        {showPreview && (
          <div
            ...
            <div className="my-4 space-y-4 px-8">
              {previewSwitched &&
                docForm === DocForm.QA &&
