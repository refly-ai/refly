...
`
const useInitialValue: <T>(depend: T, dispatch: Dispatch<T>) => void = (
  depend,
  dispatch,
) => {
  useEffect(() => {
...
const Form = () => {
  ...
  return (
    <div className="w-full p-4 sm:w-[800px] sm:px-16 sm:py-6">
      ...
      <div className={rowClass}>
        ...
        <div className="w-full max-w-[480px]">
          <textarea
            disabled={!currentDataset?.embedding_available}
            className={cn(
              `${inputClass} mb-2 block h-[120px] resize-none py-2`,
              !currentDataset?.embedding_available && "opacity-60",
            )}
          ...
          />
          <a
            className="flex h-[18px] items-center px-3 text-xs text-gray-500"
      ...
      {currentDataset && currentDataset.indexing_technique && (
        <>
          <div className="my-2 h-0 w-full border-b-[0.5px] border-b-gray-200" />
          <div className={rowClass}>
            <div className={labelClass}>
