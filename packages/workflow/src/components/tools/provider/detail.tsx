...
import { ConfigurationMethodEnum } from "@/components/header/account-setting/model-provider-page/declarations"
      ...
      <div className="flex items-center gap-2 py-1">
        <div className="relative shrink-0">
          {typeof collection.icon === "string" && (
            <div
              className="h-8 w-8 rounded-md bg-cover bg-center bg-no-repeat"
        ...
        <div className="w-0 grow py-[1px]">
          <div className="text-md flex items-center font-semibold leading-6 text-gray-900">
            <div className="truncate" title={collection.label[language]}>
              {collection.label[language]}
            </div>
          </div>
        </div>
      </div>
      <div className="mt-2 min-h-[36px] text-sm leading-[18px] text-gray-500">
      ...
      <div className="flex gap-1 border-b-[0.5px] border-black/5">
        {collection.type === CollectionType.builtIn && needAuth && (
          <Button
            ...
            className={cn("my-3 w-full shrink-0", isAuthed && "bg-white")}
            onClick={() => {
              if (
            ...
            <div
              className={cn(
                "text-[13px] font-medium leading-[18px] text-white",
        ...
        {collection.type === CollectionType.custom && !isDetailLoading && (
          <Button
            ...
            <Settings01 className="mr-1 h-4 w-4 text-gray-500" />
            ...
            <>
              <Button
                ...
                <a
                  ...
                  href={`/app/${(customCollection as WorkflowToolProviderResponse).workflow_app_id}/workflow`}
                  rel="noreferrer"
                  target="_blank">
      ...
      <div className="pt-3">
        ...
        {!isDetailLoading && (
          <div className="mt-1">
            ...
            {collection.type === CollectionType.workflow &&
              (
                customCollection as WorkflowToolProviderResponse
              )?.tool?.parameters.map(item => (
                <div
                  key={item.name}
                  className="bg-gray-25 mb-2 rounded-xl border-[0.5px] border-gray-200 px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium leading-[18px] text-[#ec4a0a]">
                      {item.required
                        ? t("tools.createTool.toolInput.required")
                        : ""}
                    </span>
                  </div>
                  <div className="h-[18px] text-xs leading-[18px] text-gray-500">
