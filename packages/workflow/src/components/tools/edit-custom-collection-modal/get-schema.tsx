  ...
  return (
    <div className="relative flex w-[224px] justify-end space-x-1">
      <div ref={importURLRef}>
        ...
        {showImportFromUrl && (
          <div className="absolute left-[-35px] top-[26px] rounded-lg border border-gray-200 bg-white p-2 shadow-lg">
            <div className="relative">
              <input
                type="text"
                className="h-8 w-[244px] overflow-x-auto rounded-lg border border-gray-200 pl-1.5 pr-[44px] text-[13px]"
      ...
      <div className="relative" ref={showExamplesRef}>
        ...
        {showExamples && (
          <div className="absolute right-0 top-7 rounded-lg bg-white p-1 shadow-sm">
            {examples.map(item => (
              <div
                key={item.key}
                onClick={() => {
                ...
                className="cursor-pointer whitespace-nowrap rounded-lg px-3 py-1.5 text-sm font-normal leading-5 text-gray-700 hover:bg-gray-50">
