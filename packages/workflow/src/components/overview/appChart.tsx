...
import Basic from "@/components/app-sidebar/basic"
...
const Chart: React.FC<IChartProps> = ({
  ...
  return (
    <div
      className={`shadow-xs flex w-full flex-col rounded-lg border-[0.5px] border-gray-200 px-6 py-4 ${className ?? ""}`}>
      <div className="mb-3">
      ...
      <div className="mb-4 flex-1">
        <Basic
              ...
              <span>
                ...
                <span className="text-sm">
                  ...
                  <span className="text-orange-400">
                    ...
                    {sum(
                      statistics.map(item =>
                        parseFloat(get(item, "total_price", "0")),
                      ),
          ...
          textStyle={{
            main: `!text-3xl !font-normal ${sumData === 0 ? "!text-gray-300" : ""}`,
          }}
        />
      </div>
...
export const ConversationsChart: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    { url: `/apps/${id}/statistics/daily-conversations`, params: period.query },
    getAppDailyConversations,
  )
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.totalMessages.title"),
        explanation: t("appOverview.analysis.totalMessages.explanation"),
...
export const EndUsersChart: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    { url: `/apps/${id}/statistics/daily-end-users`, id, params: period.query },
    getAppDailyEndUsers,
  )
  if (!response) return <Loading />
  const noDataFlag = !response.data || response.data.length === 0
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.activeUsers.title"),
        explanation: t("appOverview.analysis.activeUsers.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
...
export const AvgSessionInteractions: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/statistics/average-session-interactions`,
      params: period.query,
    },
    getAppStatistics,
  )
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.avgSessionInteractions.title"),
        explanation: t(
...
export const AvgResponseTime: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/statistics/average-response-time`,
      params: period.query,
    },
    getAppStatistics,
  )
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.avgResponseTime.title"),
        explanation: t("appOverview.analysis.avgResponseTime.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
...
export const TokenPerSecond: FC<IBizChartProps> = ({ id, period }) => {
  const { t } = useTranslation()
  const { data: response } = useSWR(
    { url: `/apps/${id}/statistics/tokens-per-second`, params: period.query },
    getAppStatistics,
  )
  if (!response) return <Loading />
  const noDataFlag = !response.data || response.data.length === 0
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.tps.title"),
        explanation: t("appOverview.analysis.tps.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
...
export const UserSatisfactionRate: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/statistics/user-satisfaction-rate`,
      params: period.query,
    },
    getAppStatistics,
  )
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.userSatisfactionRate.title"),
        explanation: t("appOverview.analysis.userSatisfactionRate.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
...
export const CostChart: FC<IBizChartProps> = ({ id, period }) => {
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.tokenUsage.title"),
        explanation: t("appOverview.analysis.tokenUsage.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
...
export const WorkflowMessagesChart: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/workflow/statistics/daily-conversations`,
      params: period.query,
    },
    getWorkflowDailyConversations,
  )
...
export const WorkflowDailyTerminalsChart: FC<IBizChartProps> = ({
  id,
  period,
}) => {
  const { t } = useTranslation()
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/workflow/statistics/daily-terminals`,
      id,
      params: period.query,
    },
    getAppDailyEndUsers,
...
export const WorkflowCostChart: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/workflow/statistics/token-costs`,
      params: period.query,
    },
    getAppTokenCosts,
  )
...
export const AvgUserInteractions: FC<IBizChartProps> = ({ id, period }) => {
  ...
  const { data: response } = useSWR(
    {
      url: `/apps/${id}/workflow/statistics/average-app-interactions`,
      params: period.query,
    },
    getAppStatistics,
  )
  ...
  return (
    <Chart
      basicInfo={{
        title: t("appOverview.analysis.avgUserInteractions.title"),
        explanation: t("appOverview.analysis.avgUserInteractions.explanation"),
        timePeriod: period.name,
      }}
      chartData={
        !noDataFlag
