...
const StepNum: FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="text-primary-600 bg-primary-50 mr-3 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-2xl">
    {children}
  </div>
)
...
const CustomizeModal: FC<IShareLinkProps> = ({
  ...
  return (
    <Modal
      ...
      closable={true}>
      <div className="mt-4 w-full rounded-lg border-[0.5px] border-gray-200 px-6 py-5">
        <Tag
          bordered={true}
          hideBg={true}
        ...
        <div className="flex py-4">
          ...
          <div className="flex flex-col">
            ...
            <a
              href={`https://github.com/langgenius/${isChatApp ? "webapp-conversation" : "webapp-text-generator"}`}
              target="_blank"
              rel="noopener noreferrer">
              <Button>
                <GithubIcon className="mr-2 text-gray-800" />
        ...
        <div className="flex pt-4">
          ...
          <div className="flex flex-col">
            ...
            <a
              ...
              rel="noopener noreferrer">
              <Button>
                <div className="mr-1.5 border-b-[12px] border-l-[7px] border-r-[7px] border-t-0 border-solid border-b-black border-l-transparent border-r-transparent border-t-transparent"></div>
        ...
        <div className="flex py-4">
          ...
          <div className="flex w-full flex-col overflow-hidden">
            ...
            <pre className="box-border select-text overflow-x-scroll rounded-lg bg-gray-100 px-4 py-3 text-xs font-medium">
      ...
      <div className="mt-4 w-full rounded-lg border-[0.5px] border-gray-200 px-6 py-5">
        ...
        <Button
          ...
          <ArrowTopRightOnSquareIcon className="ml-1 h-4 w-4 shrink-0 text-gray-800" />
        </Button>
      </div>
    </Modal>
  )
