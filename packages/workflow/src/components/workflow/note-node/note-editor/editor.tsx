...
// import TreeView from '@/components/base/prompt-editor/plugins/tree-view'
import Placeholder from "@/components/base/prompt-editor/plugins/placeholder"
        ...
        contentEditable={
          <div>
            <ContentEditable
              ...
              spellCheck={false}
              className="caret-primary-600 h-full w-full outline-none"
