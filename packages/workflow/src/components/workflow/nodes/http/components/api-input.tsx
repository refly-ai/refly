        ...
        trigger={
          <div
            className={cn(
              ...
              "flex h-8 shrink-0 items-center rounded-lg border-black/5 bg-gray-100 px-2.5",
            )}>
            <div className="w-12 pl-0.5 text-xs font-medium uppercase leading-[18px] text-gray-900">
              {method}
            </div>
            {!readonly && (
              <RiArrowDownSLine className="ml-1 h-3.5 w-3.5 text-gray-700" />
            )}
          </div>
        }
