...
import InputWithVar from "@/components/workflow/nodes/_base/components/prompt/editor"
    ...
    <div>
        ...
        {allTypes.map(t => (
          <label
            ...
            <input
              ...
              disabled={readonly}
            />
            <div className="text-[13px] font-normal leading-[18px] text-gray-700">
              {bodyTextMap[t]}
            </div>
          </label>
        ))}
      ...
      <div className={cn(type !== BodyType.none && "mt-1")}>
        ...
        {(type === BodyType.formData ||
          type === BodyType.xWwwFormUrlencoded) && (
          <KeyValue
            readonly={readonly}
            nodeId={nodeId}
            list={body}
