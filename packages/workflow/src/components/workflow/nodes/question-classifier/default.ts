  ...
  checkValid(payload: QuestionClassifierNodeType, t: any) {
    ...
    if (
      ...
      errorMessages = t(`${i18nPrefix}.errorMsg.fieldRequired`, {
        field: t(`${i18nPrefix}.nodes.questionClassifiers.inputVars`),
      })

    if (!errorMessages && !payload.model.provider)
      errorMessages = t(`${i18nPrefix}.errorMsg.fieldRequired`, {
        field: t(`${i18nPrefix}.nodes.questionClassifiers.model`),
      })

    if (!errorMessages && (!payload.classes || payload.classes.length === 0))
      errorMessages = t(`${i18nPrefix}.errorMsg.fieldRequired`, {
        field: t(`${i18nPrefix}.nodes.questionClassifiers.class`),
      })

    if (!errorMessages && payload.classes.some(item => !item.name))
      errorMessages = t(`${i18nPrefix}.errorMsg.fieldRequired`, {
        field: t(`${i18nPrefix}.nodes.questionClassifiers.topicName`),
      })
    return {
