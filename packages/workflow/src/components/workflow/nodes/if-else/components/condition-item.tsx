...
import type { Condition } from "@/components/workflow/nodes/if-else/types"
import {
  ComparisonOperator,
  LogicalOperator,
} from "@/components/workflow/nodes/if-else/types"
import type { ValueSelector, Var } from "@/components/workflow/types"
import { RefreshCw05 } from "@/components/base/icons/src/vender/line/arrows"
import Selector from "@/components/workflow/nodes/_base/components/selector"
    ...
    <div className="space-y-2">
      {isShowLogicalOperator && (
        <div className="flex select-none items-center justify-center">
          <div className="flex items-center">
            {Line}
            <div
              className="shadow-xs text-primary-600 mx-1 flex h-[22px] shrink-0 cursor-pointer items-center space-x-0.5 rounded-lg border border-gray-200 bg-white pl-2 pr-1.5"
      ...
      <div className="flex items-center space-x-1">
          ...
          trigger={
            <div
              ...
              className={cn(
                ...
                "flex h-8 w-[100px] shrink-0 items-center justify-between whitespace-nowrap rounded-lg bg-gray-100 px-2.5 capitalize",
              )}>
        ...
        <input
          ...
          className="h-8 min-w-[80px] flex-grow rounded-lg border-0 bg-gray-100 px-2.5 text-[13px] leading-8 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200"
          type="text"
        />
        {!readonly && (
          <div
