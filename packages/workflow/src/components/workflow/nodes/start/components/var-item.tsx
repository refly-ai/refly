...
import ConfigVarModal from "@/components/configuration/config-var/config-modal"
...
const VarItem: FC<Props> = ({
  ...
  return (
    <div
      ref={ref}
      className="shadow-xs flex h-8 cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white px-2.5 hover:shadow-md">
