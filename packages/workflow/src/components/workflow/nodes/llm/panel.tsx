...
import AddButton2 from "@/components/base/button/add-button"
...
import OutputVars, {
  VarItem,
} from "@/components/workflow/nodes/_base/components/output-vars"
        ...
        {isChatMode && isChatModel && !!inputs.memory && (
          <div className="mt-4">
            <div className="flex h-8 items-center justify-between rounded-lg bg-gray-100 pl-3 pr-2">
              ...
              <div className="border-black/8 flex h-[18px] items-center rounded-[5px] border px-1 text-xs font-semibold uppercase text-gray-500">
