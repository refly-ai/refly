...
const roleOptionsWithoutSystemRole = roleOptions.filter(
  item => item.value !== PromptRole.system,
)
...
const ConfigPromptItem: FC<Props> = ({
  ...
  return (
    <Editor
      ...
      value={
        payload.edition_type === EditionType.jinja2
          ? payload.jinja2_text || ""
          : payload.text
      }
