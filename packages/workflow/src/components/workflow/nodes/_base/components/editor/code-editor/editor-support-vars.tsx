...
import type { NodeOutPutVar, Variable } from "@/components/workflow/types"
...
const CodeEditor: FC<Props> = ({
  ...
  const [isShowVarPicker, { setTrue: showVarPicker, setFalse: hideVarPicker }] =
    useBoolean(false)
  ...
  useEffect(() => {
    if (isShowVarPicker && popupRef.current) {
      ...
      if (
        newPopupPosition.x !== popupPosition.x ||
        newPopupPosition.y !== popupPosition.y
      )
