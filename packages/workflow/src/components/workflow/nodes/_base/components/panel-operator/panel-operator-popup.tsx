    ...
    <div className="w-[240px] rounded-lg border-[0.5px] border-gray-200 bg-white shadow-xl">
      ...
      {data.type !== BlockEnum.Start && !nodesReadOnly && (
        <>
          ...
          <div className="p-1">
            <div
              className={`flex h-8 cursor-pointer items-center justify-between rounded-lg px-3 text-sm text-gray-700 hover:bg-rose-50 hover:text-red-500`}
