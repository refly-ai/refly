      ...
      <Field
        ...
        {payload && (
          <>
            ...
            <div className="flex justify-between">
              <div className="flex h-8 items-center space-x-1">
                <Switch
                  ...
                  disabled={readonly}
                />
                <div className="text-xs font-medium uppercase leading-[18px] text-gray-500">
              ...
              <div className="flex h-8 items-center space-x-2">
                <Slider
                  className="w-[144px]"
                  value={
                    (payload.window?.size || WINDOW_SIZE_DEFAULT) as number
                  }
                  min={WINDOW_SIZE_MIN}
                  max={WINDOW_SIZE_MAX}
                  step={1}
                ...
                <input
                  ...
                  className="text-gra-900 ml-4 block h-8 w-12 shrink-0 appearance-none rounded-lg bg-gray-100 pl-3 text-[13px] outline-none"
                  type="number"
                  min={WINDOW_SIZE_MIN}
                  max={WINDOW_SIZE_MAX}
                  step={1}
            ...
            {canSetRoleName && (
              <div className="mt-4">
                <div className="text-xs font-medium uppercase leading-6 text-gray-500">
