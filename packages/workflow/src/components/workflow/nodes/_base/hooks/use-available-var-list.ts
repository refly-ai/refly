...
const useAvailableVarList = (
  nodeId: string,
  { onlyLeafNodeVar, filterVar }: Params = {
  ...
  const availableNodes = onlyLeafNodeVar
  ...
  return {
    availableVars,
    availableNodes,
    availableNodesWithParent: iterationNode
      ? [...availableNodes, iterationNode]
      : availableNodes,
  }
}
