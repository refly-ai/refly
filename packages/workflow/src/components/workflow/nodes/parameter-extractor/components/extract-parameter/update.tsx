...
import Field from "@/components/configuration/config-var/config-modal/field"
import Select from "@/components/base/select"
import Switch from "@/components/base/switch"
import Toast from "@/components/base/toast"
import ConfigSelect from "@/components/configuration/config-var/config-select"
import { ChangeType, type MoreInfo } from "@/components/workflow/types"
...
const AddExtractParameter: FC<Props> = ({
  ...
  const checkValid = useCallback(() => {
    ...
    if (
      ...
      errMessage = t(`${errorI18nPrefix}.fieldRequired`, {
        field: t("appDebug.variableConig.options"),
      })
