    ...
    <div className="hover:shadow-xs group relative rounded-lg border-[0.5px] border-gray-200 bg-white px-2.5 py-2">
      <div className="flex justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-1 text-[13px] font-medium text-gray-900">
            {payload.name}
          </div>
        ...
        {payload.required && (
          <div className="text-xs font-normal uppercase leading-4 text-gray-500">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(270deg, #FFF 49.99%, rgba(255, 255, 255, 0.00) 98.1%)",
        }}>
        <div
