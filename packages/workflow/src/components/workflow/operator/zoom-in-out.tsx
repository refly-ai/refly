  ...
  return (
    <PortalToFollowElem
      ...
      <PortalToFollowElemTrigger asChild onClick={handleTrigger}>
        <div
          className={`h-9 cursor-pointer rounded-lg border-[0.5px] border-gray-100 bg-white p-0.5 text-[13px] font-medium text-gray-500 shadow-lg ${workflowReadOnly && "!cursor-not-allowed opacity-50"} `}>
          <div
            className={cn(
              "flex h-8 w-[98px] items-center justify-between rounded-lg hover:bg-gray-50",
              open && "bg-gray-50",
            )}>
            <TipPopup
