 ...
 * Transport type for the server connection
 */
export type type = 'sse' | 'streamableHttp';
...
export type ImportConfigRequest = {
  /**
   * JSON string containing server configurations to import
   */
  config: string;
};
...
export type ExportConfigResponse = {
  /**
   * JSON string containing exported server configurations
   */
  config?: string;
};
...
export type PostMcpTestConnectionData = {
  body: MCPServer;
};

export type PostMcpTestConnectionResponse = TestConnectionResponse;

export type PostMcpTestConnectionError = unknown;

export type GetMcpServersResponse = Array<MCPServer>;

export type GetMcpServersError = unknown;

export type PostMcpServersData = {
  body: NewMCPServer;
};

export type PostMcpServersResponse = MCPServer;

export type PostMcpServersError = unknown;

export type GetMcpServersByIdData = {
  path: {
    /**
...
export type GetMcpServersByIdResponse = MCPServer;

export type GetMcpServersByIdError = unknown;
...
export type PutMcpServersByIdResponse = MCPServer;

export type PutMcpServersByIdError = unknown;
...
export type DeleteMcpServersByIdResponse = DeleteServerResponse;

export type DeleteMcpServersByIdError = unknown;

export type PutMcpServersByIdActiveData = {
...
export type PutMcpServersByIdActiveResponse = MCPServer;

export type PutMcpServersByIdActiveError = unknown;

export type PostMcpImportConfigData = {
  body: ImportConfigRequest;
};

export type PostMcpImportConfigResponse = ImportConfigResponse;

export type PostMcpImportConfigError = unknown;

export type GetMcpExportConfigData = {
  query?: {
    /**
     * Comma-separated list of server IDs to export
     */
    ids?: string;
  };
};

export type GetMcpExportConfigResponse = ExportConfigResponse;

export type GetMcpExportConfigError = unknown;
