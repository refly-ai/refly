...
export const MCPServerSchema = {
  ...
  required: ['id', 'name', 'type', 'baseUrl', 'isActive'],
} as const;

export const NewMCPServerSchema = {
  type: 'object',
  properties: {
    name: {
      type: 'string',
  ...
  required: ['name', 'type', 'baseUrl', 'isActive'],
} as const;
...
export const DeleteServerResponseSchema = {
  type: 'object',
  properties: {
    success: {
      type: 'boolean',
...
export const ImportConfigRequestSchema = {
  type: 'object',
  properties: {
    config: {
      type: 'string',
...
export const ImportConfigResponseSchema = {
  type: 'object',
  properties: {
    success: {
      type: 'boolean',
...
export const ExportConfigResponseSchema = {
  type: 'object',
  properties: {
    config: {
      type: 'string',
