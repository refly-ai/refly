const translations = {
  ...
  landingPage: {
    ...
    featureOne: {
      ...
      description:
        'Quick summary for any website, continuous questioning, and conduct in-depth research on your favorite content',
    },
    featureTwo: {
      title: 'All-in-one Search Engine',
      description:
        ' All in one search engine supports natural language search for all your memories and builds your second brain',
    },
    featureThree: {
      title: 'Auto tag and Timeline',
      description:
        ' Automatically and tag, search and review at any time. Build a knowledge system through labels & timelines',
    },
    footer: {
      description:
        'Quick summaries, Insights, Auto tag and AI Search. Refly can build your second brain, extend knowledge and give you superpower',
