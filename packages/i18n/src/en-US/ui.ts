  ...
  canvas: {
    ...
    workflow: {
      variables: {
        ...
        saveError: 'Failed to save variables',
    ...
    resourceLibrary: {
      ...
      tip: {
        stepsRecord: 'Source from Ask AI Q&A, responses will be updated by AI at runtime.',
        resultsRecord:
          'Source from products (documents/images/videos/audio), new results are generated by AI at runtime.',
        myUpload:
          'Source from files or content you manually uploaded, remains unchanged at runtime.',
      },
      importResource: 'Import Resource',
      createDocument: 'Create Document',
