const translations = {
  ...
  copilot: {
    ...
    greeting: {
      ...
      youCanTry: '获取新灵感',
      query1:
        '研究沃伦·巴菲特在2025年第二季度与第三季度的持仓情况，列出增持和减持的股票，并生成一份包含简易图表的摘要。',
      query2:
        '使用 Perplexity 获取昨天 Product Hunt 排行榜前五的产品，创建一份摘要文档和一期播客，并通过电子邮件发送给我。',
      query3: '帮我生成一个由五张图像组成的动画系列，采用新海诚风格，主题为“成长”。',
    },
    sessionDetail: {
      thinking: '思考中',
      approve: '采纳',
