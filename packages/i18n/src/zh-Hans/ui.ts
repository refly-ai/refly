const translations = {
  ...
  integration: {
    ...
    skill: {
      title: 'Skill 集成',
      description: '将 Skill 接入画布工作流。',
      comingSoonDescription: 'Skill 集成功能正在开发中，敬请期待。',
    },
    api: {
      title: 'API 集成',
      description: '通过 API 触发工作流并管理 Webhook。',
      overviewTitle: '概览',
      overviewDescription: '通过这些 API 可以编程触发工作流并管理 Webhook 集成。',
      authTitle: '认证',
  ...
  webhook: {
    ...
    instruction2: '请求体为 JSON，字段会映射为工作流变量。',
    ...
    apiKey: {
      ...
      copyWarning: '此 Key 只会显示一次，请及时保存。',
