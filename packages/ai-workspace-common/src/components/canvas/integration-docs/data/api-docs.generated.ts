...
export const apiDocsData: ApiDocsData = {
  ...
  endpoints: [
    ...
    {
      id: 'post-openapi-share-workflow-canvasid',
      method: 'POST',
      path: '/openapi/share/workflow/{canvasId}',
      operationId: 'createWorkflowShareViaApi',
      summary: 'Create workflow share via API',
      summaryKey: 'integration.api.openapi.workflowShare.summary',
      description:
        'Create a share link for a workflow. The canvasId can be obtained from the browser URL.',
      descriptionKey: 'integration.api.openapi.workflowShare.description',
      tags: ['workflow'],
      security: ['bearerAuth', 'api_key'],
      parameters: [
        {
          ...
          type: 'string',
          description: 'Canvas/Workflow ID',
          descriptionKey: 'integration.api.openapi.workflowShare.paramCanvasId',
        },
      ],
      requestBody: {
        required: false,
      ...
      responses: {
        '200': {
          description: 'Workflow share created successfully',
          descriptionKey: 'integration.api.openapi.workflowShare.response200',
          schema: {
            type: 'object',
            properties: {
              success: {
        ...
        '401': {
          description: 'Unauthorized - invalid or missing API key',
          descriptionKey: 'integration.api.openapi.workflowShare.response401',
        },
        '404': {
          description: 'Workflow not found',
          descriptionKey: 'integration.api.openapi.workflowShare.response404',
        },
      },
    },
    {
      id: 'delete-openapi-share-workflow-shareid',
      method: 'DELETE',
      path: '/openapi/share/workflow/{shareId}',
      operationId: 'deleteWorkflowShareViaApi',
      summary: 'Delete workflow share via API',
      summaryKey: 'integration.api.openapi.workflowShareDelete.summary',
      description: 'Delete a workflow share by shareId',
      descriptionKey: 'integration.api.openapi.workflowShareDelete.description',
      tags: ['workflow'],
      security: ['bearerAuth', 'api_key'],
      parameters: [
        {
          ...
          type: 'string',
          description: 'Share ID',
          descriptionKey: 'integration.api.openapi.workflowShareDelete.paramShareId',
        },
      ],
      responses: {
        '200': {
          description: 'Workflow share deleted successfully',
          descriptionKey: 'integration.api.openapi.workflowShareDelete.response200',
          schema: {
            type: 'object',
            required: ['success'],
            properties: {
        ...
        '401': {
          description: 'Unauthorized - invalid or missing API key',
          descriptionKey: 'integration.api.openapi.workflowShareDelete.response401',
        },
        '404': {
          description: 'Share not found',
          descriptionKey: 'integration.api.openapi.workflowShareDelete.response404',
        },
      },
    },
    {
      id: 'post-openapi-share-workflow-shareid-duplicate',
      method: 'POST',
      path: '/openapi/share/workflow/{shareId}/duplicate',
      operationId: 'duplicateWorkflowShareViaApi',
      summary: 'Duplicate shared workflow via API',
      summaryKey: 'integration.api.openapi.workflowShareDuplicate.summary',
      description:
        'Duplicate a shared workflow to your account. The shareId can be obtained from the share URL.',
      descriptionKey: 'integration.api.openapi.workflowShareDuplicate.description',
      tags: ['workflow'],
      security: ['bearerAuth', 'api_key'],
      parameters: [
        {
          ...
          type: 'string',
          description: 'Share ID',
          descriptionKey: 'integration.api.openapi.workflowShareDuplicate.paramShareId',
        },
      ],
      requestBody: {
        required: false,
      ...
      responses: {
        '200': {
          ...
          descriptionKey: 'integration.api.openapi.workflowShareDuplicate.response200',
          schema: {
            type: 'object',
            properties: {
              success: {
        ...
        '401': {
          description: 'Unauthorized - invalid or missing API key',
          descriptionKey: 'integration.api.openapi.workflowShareDuplicate.response401',
        },
        '403': {
          description: 'Duplication not allowed',
          descriptionKey: 'integration.api.openapi.workflowShareDuplicate.response403',
        },
        '404': {
          description: 'Share not found',
          descriptionKey: 'integration.api.openapi.workflowShareDuplicate.response404',
        },
      },
    },
    {
