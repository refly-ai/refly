...
- `references/` - Core CLI docs (`workflow.md`, `node.md`, `file.md`, `skill.md`)
- `~/.claude/skills/refly/references/` - Domain skill entries (one file per skill)
- `~/.claude/skills/refly/registry.json` - Routing registry
