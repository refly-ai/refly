...
Note: You can't use this message in a manifest file.
     ...
     *
     * "Refly: The AI Native Creation Engine"
     */
    getMessage(
      messageName: "name",
      substitutions?: string | string[],
     ...
     *
     * "An OpenSource AI-powered free-form canvas with multi-threaded dialogue, knowledge base, intelligent search, and WYSIWYG AI editor"
     */
    getMessage(
