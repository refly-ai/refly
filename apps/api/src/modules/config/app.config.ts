...
export default () => ({
  ...
  drive: {
    ...
    maxParseFileSizeMB: Number.parseInt(process.env.DRIVE_MAX_PARSE_FILE_SIZE_MB) || 1, // Maximum file size (MB) for direct parsing, larger files should use execute_code
  },
  session: {
