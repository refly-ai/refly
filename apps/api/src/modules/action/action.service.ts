...
export class ActionService {
  ...
  // Store active abort controllers for running actions
  ...
  registerAbortController(resultId: string, controller: AbortController) {
    this.activeAbortControllers.set(resultId, controller);
  ...
  async abortAction(user: User, { resultId }: { resultId: string }) {
    ...
    const controller = this.activeAbortControllers.get(resultId);
